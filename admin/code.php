...
elseif (isset($_POST['add_product_btn'])) 
{
    ...
    if($name != "" && $slug != "" && $description != "")
    {
        ...
        VALUES('$category_id','$name','$slug','$small_description','$description','$original_price','$selling_price','$filename',
        '$qty','$status','$trending','$meta_title','$meta_keywords','$meta_description')";
...
elseif (isset($_POST['delete_user_btn'])) {
    ...
    $updateOrder = "UPDATE orders SET status='$order_status' WHERE tracking_no ='$track_no' ";
    $updateOrder_run = mysqli_query($con, $updateOrder);
